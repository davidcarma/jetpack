						...
						if ( t.options.toggleCaptionsButtonWhenOnlyOne && subtitleCount === 1 ) {
							...
							for ( var _i3 = 0, _total = inEvents.length; _i3 < _total; _i3++ ) {
								player.captionsButton.addEventListener( inEvents[ _i3 ], function () {
									( 0, _dom.removeClass )(
										this.querySelector( '.' + t.options.classPrefix + 'captions-selector' ),
					...
					dfxp: {
						parse: function parse( trackText ) {
							var trackElem = _document2.default.adoptNode(
									new DOMParser().parseFromString( trackText, 'application/xml' ).documentElement
								),
						...
						},
						{
							...
							value: function _meReady( media, domNode ) {
								var t = this,
									...
									isNative =
										media.rendererName !== null && /(native|html5)/i.test( media.rendererName );

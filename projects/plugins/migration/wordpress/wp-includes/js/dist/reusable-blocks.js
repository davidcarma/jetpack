/******/ ( function () {
	...
	__webpack_require__.d( __webpack_exports__, {
		ReusableBlocksMenuItems: function () {
			return /* reexport */ ReusableBlocksMenuItems;
		},
		store: function () {
	...
	var external_wp_coreData_namespaceObject = window[ 'wp' ][ 'coreData' ]; // CONCATENATED MODULE: external ["wp","privateApis"]
	var external_wp_privateApis_namespaceObject = window[ 'wp' ][ 'privateApis' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/reusable-blocks/build-module/lock-unlock.js
	/**
	 * WordPress dependencies
	 */
	...
	function ReusableBlockConvertButton( { clientIds, rootClientId, onClose } ) {
		...
		const { __experimentalConvertBlocksToReusable: convertBlocksToReusable } = ( 0,
		...
		return ( 0, external_wp_element_namespaceObject.createElement )(
			...
			( 0, external_wp_element_namespaceObject.createElement )(
				...
				showRenameHint
					? ( 0, external_wp_i18n_namespaceObject.__ )( 'Create pattern/reusable block' )
	...
	/* harmony default export */ var reusable_blocks_manage_button = ReusableBlocksManageButton; // CONCATENATED MODULE: ./node_modules/@wordpress/reusable-blocks/build-module/components/reusable-blocks-menu-items/index.js
		...
		return ( 0, external_wp_element_namespaceObject.createElement )(
			...
			( { onClose, selectedClientIds } ) =>
				( 0, external_wp_element_namespaceObject.createElement )(
					external_wp_element_namespaceObject.Fragment,
					null,
					( 0, external_wp_element_namespaceObject.createElement )( ReusableBlockConvertButton, {

/******/ ( function () {
	...
	/******/ var __webpack_modules__ = {
		/***/ 754: /***/ function (
			...
			__webpack_require__.d( __webpack_exports__, {
				c4: function () {
					return /* reexport */ router_navigate;
				},
				tL: function () {
					return /* reexport */ prefetch;
				},
				h: function () {
			...
			function y( l, u, t ) {
				...
				if (
					( arguments.length > 2 &&
						( f.children = arguments.length > 3 ? preact_module_n.call( arguments, 2 ) : t ),
			...
			function w( n ) {
				( ( ! n.__d && ( n.__d = ! 0 ) && i.push( n ) && ! x.__r++ ) ||
					...
					( ( preact_module_o = preact_module_l.debounceRendering ) || r )( x );
			}
			function x() {
				var n, l, u, t, o, r, e, c, s;
				for ( i.sort( preact_module_f ); ( n = i.shift() );  )
					n.__d &&
						( ( l = i.length ),
						( t = void 0 ),
						( o = void 0 ),
						...
						( s = u.__P ) &&
							...
							L( t, r, o ),
							r.__e != c && g( r ) ),
						i.length > l && i.sort( preact_module_f ) );
				x.__r = 0;
			}
			function C( n, l, u, t, i, o, r, f, e, a, h ) {
				...
				for ( u.__k = [], p = 0; p < j; p++ )
					null !=
					( m = u.__k[ p ] =
						null == ( m = l[ p ] ) || 'boolean' == typeof m || 'function' == typeof m
							? null
							: m.constructor == String || 'number' == typeof m || 'bigint' == typeof m
						...
						? ( ( m.__ = u ),
						  ...
						  -1 === ( C = A( m, H, ( x = p + D ), T ) )
								? ( _ = preact_module_c )
								: ( ( _ = H[ C ] || preact_module_c ), ( H[ C ] = void 0 ), T-- ),
						  z( n, m, _, i, o, r, f, e, a, h ),
						  ( g = m.__e ),
						  ( y = m.ref ) &&
								_.ref != y &&
								( _.ref && N( _.ref, null, m ), h.push( y, m.__c || g, m ) ),
						  null == w && null != g && ( w = g ),
						  ( $ = _ === preact_module_c || null === _.__v )
								? -1 == C && D--
								: C !== x &&
								  ( C === x + 1
										? D++
						  ...
						  'function' == typeof m.type
								? ( C !== x || _.__k === m.__k
										...
										: g && ( e = g.nextSibling ),
								  ( m.__d = void 0 ) )
								: g && ( e = C !== x || $ ? S( n, g, e ) : g.nextSibling ),
						  'function' == typeof u.type && ( u.__d = e ) )
						: ( _ = H[ p ] ) &&
						  null == _.key &&
						  _.__e &&
						  ( _.__e == e && ( ( e = b( _ ) ), 'function' == typeof u.type && ( u.__d = e ) ),
						  O( _, _, ! 1 ),
						  ( H[ p ] = null ) );
				for ( u.__e = w, p = I; p--;  )
					null != H[ p ] &&
						( 'function' == typeof u.type &&
							null != H[ p ].__e &&
							H[ p ].__e == e &&
							( u.__d = H[ p ].__e.nextSibling ),
						O( H[ p ], H[ p ] ) );
			}
			function P( n, l, u ) {
				for ( var t, i = n.__k, o = 0; i && o < i.length; o++ )
					( t = i[ o ] ) &&
						( ( t.__ = n ), ( l = 'function' == typeof t.type ? P( t, l, u ) : S( u, t.__e, l ) ) );
				return l;
			}
			function $( n, l ) {
				return (
				...
				n: if ( 'style' === l ) {
					if ( 'string' == typeof u ) n.style.cssText = u;
						...
						if ( ( 'string' == typeof t && ( n.style.cssText = t = '' ), t ) )
							for ( l in t ) ( u && l in u ) || H( n.style, l, '' );
					...
					( o = l !== ( l = l.replace( /(PointerCapture)$|Capture$/, '$1' ) ) ),
						...
						u
							? t
								? ( u.u = t.u )
								: ( ( u.u = Date.now() ), n.addEventListener( l, o ? j : T, o ) )
							: n.removeEventListener( l, o ? j : T, o );
			...
			function z( n, u, t, i, o, r, f, e, c, s ) {
				...
				null != t.__h && ( ( c = t.__h ), ( e = u.__e = t.__e ), ( u.__h = null ), ( r = [ e ] ) ),
					( a = preact_module_l.__b ) && a( u );
				n: if ( 'function' == typeof I )
					try {
						if (
							( ( w = u.props ),
							( x = ( a = I.contextType ) && i[ a.__c ] ),
							( P = a ? ( x ? x.props.value : a.__ ) : i ),
							t.__c
								? ( g = ( p = u.__c = t.__c ).__ = p.__E )
								: ( 'prototype' in I && I.prototype.render
										? ( u.__c = p = new I( w, P ) )
										: ( ( u.__c = p = new m( w, P ) ), ( p.constructor = I ), ( p.render = q ) ),
								  x && x.sub( p ),
								  ( p.props = w ),
								  p.state || ( p.state = {} ),
								  ( p.context = P ),
							...
							null != I.getDerivedStateFromProps &&
								...
								h( p.__s, I.getDerivedStateFromProps( w, p.__s ) ) ),
							( d = p.props ),
							( _ = p.state ),
							( p.__v = u ),
							y )
						...
						( p.state = p.__s ),
							null != p.getChildContext && ( i = h( h( {}, i ), p.getChildContext() ) ),
							y || null == p.getSnapshotBeforeUpdate || ( b = p.getSnapshotBeforeUpdate( d, _ ) ),
							C(
								n,
								v( ( H = null != a && a.type === k && null == a.key ? a.props.children : a ) )
									? H
									: [ H ],
								u,
								t,
			...
			function M( l, u, t, i, o, r, f, e, s ) {
				...
				if ( null === k ) d === _ || ( e && l.data === _ ) || ( l.data = _ );
					...
					if (
						( ( r = r && preact_module_n.call( l.childNodes ) ),
						( h = ( d = t.props || preact_module_c ).dangerouslySetInnerHTML ),
						( y = _.dangerouslySetInnerHTML ),
						! e )
					) {
						if ( null != r )
							for ( d = {}, m = 0; m < l.attributes.length; m++ )
								d[ l.attributes[ m ].name ] = l.attributes[ m ].value;
						( y || h ) &&
							( ( y && ( ( h && y.__html == h.__html ) || y.__html === l.innerHTML ) ) ||
								( l.innerHTML = ( y && y.__html ) || '' ) );
					}
					if ( ( D( l, _, d, o, e ), y ) ) u.__k = [];
					else if (
						( C(
							l,
							v( ( m = u.props.children ) ) ? m : [ m ],
							u,
							t,
							i,
							o && 'foreignObject' !== k,
						...
						for ( m = r.length; m--;  ) null != r[ m ] && p( r[ m ] );
					e ||
						( 'value' in _ &&
							void 0 !== ( m = _.value ) &&
							( m !== l.value ||
								( 'progress' === k && ! m ) ||
								( 'option' === k && m !== d.value ) ) &&
							I( l, 'value', m, d.value, ! 1 ),
						'checked' in _ &&
							void 0 !== ( m = _.checked ) &&
							m !== l.checked &&
							I( l, 'checked', m, d.checked, ! 1 ) );
				}
				return l;
			}
			function N( n, u, t ) {
			...
			function B( u, t, i ) {
				var o, r, f, e;
				preact_module_l.__ && preact_module_l.__( u, t ),
					( r = ( o = 'function' == typeof i ) ? null : ( i && i.__k ) || t.__k ),
					( f = [] ),
					( e = [] ),
					z(
						t,
						( u = ( ( ! o && i ) || t ).__k = y( k, null, [ u ] ) ),
						r || preact_module_c,
						preact_module_c,
						...
						! o && i
							...
							? null
							: t.firstChild
							? preact_module_n.call( t.childNodes )
							: null,
						f,
			...
			function F( l, u, t ) {
				...
				return (
					arguments.length > 2 &&
						( e.children = arguments.length > 3 ? preact_module_n.call( arguments, 2 ) : t ),
			...
			( preact_module_n = s.slice ),
				...
				( x.__r = 0 ),
				( preact_module_e = 0 ); // CONCATENATED MODULE: ./node_modules/preact/hooks/dist/hooks.module.js
			...
			function hooks_module_d( t, u ) {
				preact_module_l.__h && preact_module_l.__h( hooks_module_r, t, hooks_module_o || u ),
					( hooks_module_o = 0 );
				var i =
					hooks_module_r.__H ||
					( hooks_module_r.__H = {
			...
			function hooks_module_p( u, i ) {
				...
				! preact_module_l.__s &&
					hooks_module_z( o.__H, i ) &&
					( ( o.__ = u ), ( o.i = i ), hooks_module_r.__H.__h.push( o ) );
			}
			function hooks_module_y( u, i ) {
				var o = hooks_module_d( hooks_module_t++, 4 );
				! preact_module_l.__s &&
					hooks_module_z( o.__H, i ) &&
					( ( o.__ = u ), ( o.i = i ), hooks_module_r.__h.push( o ) );
			}
			...
			function hooks_module_q( n ) {
				...
				return (
					( i.c = n ),
					u ? ( null == i.__ && ( ( i.__ = ! 0 ), u.sub( hooks_module_r ) ), u.props.value ) : n.__
				);
			}
					...
					if ( t.__P && t.__H )
						try {
							t.__H.__h.forEach( hooks_module_k ),
								t.__H.__h.forEach( hooks_module_w ),
								( t.__H.__h = [] );
						} catch ( r ) {
			...
			( preact_module_l.__b = function ( n ) {
				...
				( preact_module_l.__r = function ( n ) {
					...
					i &&
						( hooks_module_u === hooks_module_r
							...
							: ( i.__h.forEach( hooks_module_k ),
							  i.__h.forEach( hooks_module_w ),
							  ( i.__h = [] ),
							  ( hooks_module_t = 0 ) ) ),
						( hooks_module_u = hooks_module_r );
				} ),
				( preact_module_l.diffed = function ( t ) {
					...
					o &&
						o.__H &&
						( o.__H.__h.length &&
							( ( 1 !== hooks_module_f.push( o ) &&
								hooks_module_i === preact_module_l.requestAnimationFrame ) ||
								( ( hooks_module_i = preact_module_l.requestAnimationFrame ) || hooks_module_j )(
									hooks_module_b
								) ),
				...
				if ( ! ( signals_core_module_v > 1 ) ) {
					...
					while ( void 0 !== signals_core_module_f ) {
						...
						while ( void 0 !== r ) {
							...
							r.o = void 0;
							r.f &= -3;
							if ( ! ( 8 & r.f ) && signals_core_module_l( r ) )
								try {
									r.c();
								} catch ( r ) {
									if ( ! t ) {
			...
			Object.defineProperty( signals_core_module_d.prototype, 'value', {
				...
				set: function ( t ) {
					if ( signals_core_module_o instanceof signals_core_module_ )
						! ( function () {
			...
			var deepsignal_module_a = new WeakMap(),
				...
				deepsignal_module_l = function ( e ) {
					...
					return (
						deepsignal_module_o.has( e ) ||
							deepsignal_module_o.set( e, deepsignal_module_h( e, deepsignal_module_v ) ),
						deepsignal_module_o.get( e )
					);
				},
				...
				deepsignal_module_y = function ( e ) {
					return function ( t, c, u ) {
						...
						if ( ! e && g && Array.isArray( t ) ) {
							if ( '$' === c )
								return (
									deepsignal_module_s.has( t ) ||
										deepsignal_module_s.set( t, deepsignal_module_h( t, deepsignal_module_w ) ),
									deepsignal_module_s.get( t )
								);
							g = '$length' === c;
						}
						...
						if (
							p.has( y ) ||
							'function' !=
								typeof ( null == ( l = Object.getOwnPropertyDescriptor( t, y ) ) ? void 0 : l.get )
						) {
							var b = Reflect.get( t, y, u );
							if ( g && 'function' == typeof b ) return;
							if ( 'symbol' == typeof y && deepsignal_module_m.has( y ) ) return b;
							p.has( y ) ||
								( deepsignal_module_d( b ) &&
									( deepsignal_module_o.has( b ) ||
										deepsignal_module_o.set( b, deepsignal_module_h( b, deepsignal_module_v ) ),
									( b = deepsignal_module_o.get( b ) ) ),
								p.set( y, signals_core_module_a( b ) ) );
						} else
							p.set(
								y,
				...
				deepsignal_module_v = {
					...
					set: function ( e, n, s, c ) {
						...
						var g = s;
						deepsignal_module_d( s ) &&
							( deepsignal_module_o.has( s ) ||
								deepsignal_module_o.set( s, deepsignal_module_h( s, deepsignal_module_v ) ),
							( g = deepsignal_module_o.get( s ) ) );
						var y = ! ( n in e ),
							w = Reflect.set( e, n, s, c );
						return (
							f.has( n ) ? ( f.get( n ).value = g ) : f.set( n, signals_core_module_a( g ) ),
							y && deepsignal_module_u.has( e ) && deepsignal_module_u.get( e ).value++,
							Array.isArray( e ) && f.has( 'length' ) && ( f.get( 'length' ).value = e.length ),
							w
						);
					},
					deleteProperty: function ( e, t ) {
						...
						return (
							...
							deepsignal_module_u.has( e ) && deepsignal_module_u.get( e ).value++,
							n
						);
					},
					ownKeys: function ( e ) {
						return (
							deepsignal_module_u.has( e ) ||
								deepsignal_module_u.set( e, signals_core_module_a( 0 ) ),
							( deepsignal_module_u._ = deepsignal_module_u.get( e ).value ),
							Reflect.ownKeys( e )
						);
					},
				},
				...
				deepsignal_module_d = function ( e ) {
					return (
						...
						( ! (
							...
							deepsignal_module_b.has( e.constructor ) ) &&
						! deepsignal_module_c.has( e )
					);
				},
			 ...
			 */
			const store = ( { state, ...block }, { afterLoad } = {} ) => {
			...
			function jsxRuntime_module_o( o, e, n, t, f, l ) {
				...
				if ( 'function' == typeof o && ( s = o.defaultProps ) )
					for ( i in s ) void 0 === u[ i ] && ( u[ i ] = s[ i ] );
			...
			const Directives = ( {
				...
				const children =
					nextPriorityLevels.length > 0
						? jsxRuntime_module_o( Directives, {
			...
			const directives_isObject = item =>
				item && typeof item === 'object' && ! Array.isArray( item );
			const mergeDeepSignals = ( target, source, overwrite ) => {
				for ( const k in source ) {
					if (
						directives_isObject( deepsignal_module_g( target, k ) ) &&
						directives_isObject( deepsignal_module_g( source, k ) )
					) {
			...
			/* harmony default export */ var directives = () => {
						...
						Object.keys( className )
							...
							.forEach( name => {
								...
								if ( ! result )
									...
									element.props.class = currentClass ? `${ currentClass } ${ name }` : name;
								hooks_module_p( () => {
				...
				directive( 'style', ( { directives: { style }, element, evaluate, context } ) => {
					const contextValue = hooks_module_q( context );
					Object.keys( style )
						.filter( n => n !== 'default' )
						.forEach( key => {
				...
				directive( 'bind', ( { directives: { bind }, element, context, evaluate } ) => {
					const contextValue = hooks_module_q( context );
					Object.entries( bind )
						.filter( n => n !== 'default' )
			...
			const directivePrefix = 'wp'; // CONCATENATED MODULE: ./node_modules/@wordpress/interactivity/src/vdom.js
			/**
			 * External dependencies
			 */
	...
	/******/ ! ( function () {
		...
		/******/
		/******/ var chunkLoadingGlobal = ( self[ '__WordPressPrivateInteractivityAPI__' ] =

...
*/
	...
	! ( function () {
		...
		/* harmony default export */ var complementary_area = ComplementaryAreaWrapped; // CONCATENATED MODULE: external ["wp","compose"]
		...
		function transformBlockToWidget( block, relatedWidget = {} ) {
			...
			const isValidLegacyWidgetBlock =
				block.name === 'core/legacy-widget' && ( block.attributes.id || block.attributes.instance );
			...
			async ( { select, dispatch, registry } ) => {
				...
				try {
					...
					registry
						...
						.createSuccessNotice( ( 0, external_wp_i18n_namespaceObject.__ )( 'Widgets saved.' ), {
							type: 'snackbar',
						} );
				} catch ( e ) {
					registry.dispatch( external_wp_notices_namespaceObject.store ).createErrorNotice(
						...
						( 0, external_wp_i18n_namespaceObject.sprintf )(
							( 0, external_wp_i18n_namespaceObject.__ )( 'There was an error. %s' ),
							e.message
						),
						{
							type: 'snackbar',
		...
		const saveWidgetArea =
			...
			async ( { dispatch, select, registry } ) => {
				...
				const post = registry
					...
					.getEditedEntityRecord( KIND, POST_TYPE, buildWidgetAreaPostId( widgetAreaId ) );
		 ...
		 */
		const selectors_getWidgetAreas = ( 0, external_wp_data_namespaceObject.createRegistrySelector )(
			select => () => {
				const query = buildWidgetAreasQuery();
		...
		const getEditedWidgetAreas = ( 0, external_wp_data_namespaceObject.createRegistrySelector )(
			select => ( state, ids ) => {
				...
				return widgetAreas
					...
					.map( ( { id } ) =>
						select( external_wp_coreData_namespaceObject.store ).getEditedEntityRecord(
							KIND,
							WIDGET_AREA_ENTITY_TYPE,
							id
						)
		 ...
		 */
		const isSavingWidgetAreas = ( 0, external_wp_data_namespaceObject.createRegistrySelector )(
			select => () => {
		...
		external_wp_data_namespaceObject.createRegistrySelector )( select => ( state, blockName ) => {
		...
		external_wp_compose_namespaceObject.createHigherOrderComponent )(
			BlockEdit => props => {
				...
				const { widgetAreas, currentWidgetAreaId, canInsertBlockInWidgetArea } = ( 0,
				external_wp_data_namespaceObject.useSelect )(
					select => {
				...
				const { moveBlockToWidgetArea } = ( 0, external_wp_data_namespaceObject.useDispatch )(
					store_store
				);
				const hasMultipleWidgetAreas = widgetAreas?.length > 1;
				const isMoveToWidgetAreaVisible =
					blockName !== 'core/widget-area' && hasMultipleWidgetAreas && canInsertBlockInWidgetArea;
				return ( 0, external_wp_element_namespaceObject.createElement )(
					external_wp_element_namespaceObject.Fragment,
					null,
		...
		/* harmony default export */ var use_is_dragging_within = useIsDraggingWithin; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/blocks/widget-area/edit/inner-blocks.js
		...
		function WidgetAreaInnerBlocks( { id } ) {
			...
			external_wp_coreData_namespaceObject.useEntityBlockEditor )( 'root', 'postType' );
		...
		function WidgetAreaEdit( { clientId, className, attributes: { id, name } } ) {
			...
			const { setIsWidgetAreaOpen } = ( 0, external_wp_data_namespaceObject.useDispatch )(
				store_store
			);
		...
		const useIsDragging = elementRef => {
			const [ isDragging, setIsDragging ] = ( 0, external_wp_element_namespaceObject.useState )(
				false
			);
			( 0, external_wp_element_namespaceObject.useEffect )( () => {
				const { ownerDocument } = elementRef.current;
		...
		var external_wp_patterns_namespaceObject = window[ 'wp' ][ 'patterns' ]; // CONCATENATED MODULE: external ["wp","keyboardShortcuts"]
		var external_wp_keyboardShortcuts_namespaceObject = window[ 'wp' ][ 'keyboardShortcuts' ]; // CONCATENATED MODULE: external ["wp","keycodes"]
		...
		function KeyboardShortcuts() {
			...
			const { saveEditedWidgetAreas } = ( 0, external_wp_data_namespaceObject.useDispatch )(
				store_store
			);
		...
		/* harmony default export */ var use_last_selected_widget_area = useLastSelectedWidgetArea; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/constants.js

		const ALLOW_REUSABLE_BLOCKS = false;
		const ENABLE_EXPERIMENTAL_FSE_BLOCKS = false; // CONCATENATED MODULE: external ["wp","privateApis"]

		var external_wp_privateApis_namespaceObject = window[ 'wp' ][ 'privateApis' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/lock-unlock.js
		/**
		 * WordPress dependencies
		 */
		...
		function WidgetAreasBlockEditorProvider( { blockEditorSettings, children, ...props } ) {
			const mediaPermissions = ( 0, external_wp_coreData_namespaceObject.useResourcePermissions )(
				'media'
			);
			...
			const [ blocks, onInput, onChange ] = ( 0,
			external_wp_coreData_namespaceObject.useEntityBlockEditor )( KIND, POST_TYPE, {
			...
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				( 0, external_wp_element_namespaceObject.createElement )(
					...
					( 0, external_wp_element_namespaceObject.createElement )( PatternsMenuItems, {
		...
		/* harmony default export */ var drawer_right = drawerRight; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/block-default.js
		...
		function ComplementaryAreaTab( { identifier, label, isActive } ) {
			const { enableComplementaryArea } = ( 0, external_wp_data_namespaceObject.useDispatch )(
				store
			);
			return ( 0, external_wp_element_namespaceObject.createElement )(
				external_wp_components_namespaceObject.Button,
				...
				complementary_area,
				{
					...
					header: ( 0, external_wp_element_namespaceObject.createElement )(
						...
						( 0, external_wp_element_namespaceObject.createElement )(
							'li',
							null,
							( 0, external_wp_element_namespaceObject.createElement )( ComplementaryAreaTab, {
		...
		/* harmony default export */ var keyboard_shortcut_help_modal_shortcut = Shortcut; // CONCATENATED MODULE: ./node_modules/@wordpress/edit-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js
		...
		external_wp_components_namespaceObject.createSlotFill )( 'EditWidgetsToolsMoreMenuGroup' );
		...
		function MoreMenu() {
			const [ isKeyboardShortcutsModalActive, setIsKeyboardShortcutsModalVisible ] = ( 0,
			external_wp_element_namespaceObject.useState )( false );
			...
			return ( 0, external_wp_element_namespaceObject.createElement )(
				external_wp_element_namespaceObject.Fragment,
				null,
				( 0, external_wp_element_namespaceObject.createElement )( MoreMenuDropdown, null, onClose =>
					( 0, external_wp_element_namespaceObject.createElement )(
						external_wp_element_namespaceObject.Fragment,
						null,
						isLargeViewport &&
		...
		function Header( { setListViewToggleElement } ) {
			const isMediumViewport = ( 0, external_wp_compose_namespaceObject.useViewportMatch )(
				'medium'
			);
			const inserterButton = ( 0, external_wp_element_namespaceObject.useRef )();
			const widgetAreaClientId = use_last_selected_widget_area();
			const isLastSelectedWidgetAreaOpen = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => select( store_store ).getIsWidgetAreaOpen( widgetAreaClientId ),
				[ widgetAreaClientId ]
			);
			const { isInserterOpen, isListViewOpen } = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => {
			...
			const { setIsWidgetAreaOpen, setIsInserterOpened, setIsListViewOpened } = ( 0,
    ...
    characters. */ label: ( 0, external_wp_i18n_namespaceObject._x )(
							...
							isMediumViewport &&
								( 0, external_wp_element_namespaceObject.createElement )(
									external_wp_element_namespaceObject.Fragment,
									null,
									( 0, external_wp_element_namespaceObject.createElement )( UndoButton, null ),
									( 0, external_wp_element_namespaceObject.createElement )( RedoButton, null ),
									( 0, external_wp_element_namespaceObject.createElement )(
										external_wp_components_namespaceObject.ToolbarItem,
										{
											as: external_wp_components_namespaceObject.Button,
					...
					( 0, external_wp_element_namespaceObject.createElement )(
						...
						( 0, external_wp_element_namespaceObject.createElement )( save_button, null ),
		...
		const useWidgetLibraryInsertionPoint = () => {
			...
			return ( 0, external_wp_data_namespaceObject.useSelect )(
				select => {
					const { getBlockRootClientId, getBlockSelectionEnd, getBlockOrder, getBlockIndex } =
						select( external_wp_blockEditor_namespaceObject.store );
		...
		function SecondarySidebar( { listViewToggleElement } ) {
			const { isInserterOpen, isListViewOpen } = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => {
					const { isInserterOpened, isListViewOpened } = select( store_store );
					return {
		...
		function Interface( { blockEditorSettings } ) {
			...
			return ( 0, external_wp_element_namespaceObject.createElement )( interface_skeleton, {
				...
				secondarySidebar:
					hasSecondarySidebar &&
					( 0, external_wp_element_namespaceObject.createElement )( SecondarySidebar, {
						listViewToggleElement: listViewToggleElement,
					} ),
				sidebar:
					hasSidebarEnabled &&
				...
				content: ( 0, external_wp_element_namespaceObject.createElement )(
					external_wp_element_namespaceObject.Fragment,
					null,
					( 0, external_wp_element_namespaceObject.createElement )( WidgetAreasBlockEditorContent, {
		...
		function Layout( { blockEditorSettings } ) {
			...
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				( 0, external_wp_element_namespaceObject.createElement )(
					...
					( 0, external_wp_element_namespaceObject.createElement )( UnsavedChangesWarning, null ),
		...
		function initializeEditor( id, settings ) {
			...
			const coreBlocks = ( 0,
			external_wp_blockLibrary_namespaceObject.__experimentalGetCoreBlocks )().filter( block => {
				return ! (

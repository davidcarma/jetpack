/******/ ( function () {
	...
	function isRequestingDownloadableBlocks( state, filterValue ) {
		...
		return ( _state$downloadableBl = state.downloadableBlocks[ filterValue ]?.isRequesting ) !==
			null && _state$downloadableBl !== void 0
	...
	function getDownloadableBlocks( state, filterValue ) {
		...
		return ( _state$downloadableBl2 = state.downloadableBlocks[ filterValue ]?.results ) !== null &&
	...
	async function loadAssets() {
		...
		const newAssets = Array.from( doc.querySelectorAll( 'link[rel="stylesheet"],script' ) ).filter(
						...
						( 0, external_wp_blocks_namespaceObject.unstable__bootstrapServerSideBlockDefinitions )(
							{
								[ name ]: Object.fromEntries(
									Object.entries( response ).filter( ( [ key ] ) => metadataFields.includes( key ) )
								),
							}
						);
					} );
...
***************************************************************************** */
		...
		async ( { dispatch } ) => {
			...
			try {
				...
				const blocks = results.map( result =>
					Object.fromEntries(
						Object.entries( result ).map( ( [ key, value ] ) => [ camelCase( key ), value ] )
					)
				);
	...
	var external_wp_coreData_namespaceObject = window[ 'wp' ][ 'coreData' ]; // CONCATENATED MODULE: external ["wp","htmlEntities"]
	...
	/* harmony default export */ var downloadable_block_icon = DownloadableBlockIcon; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-notice/index.js
	...
	const DownloadableBlockNotice = ( { block } ) => {
		...
		return ( 0, external_wp_element_namespaceObject.createElement )(
			...
			( 0, external_wp_element_namespaceObject.createElement )(
				...
				errorNotice.message,
				errorNotice.isFatal
					? ' ' + ( 0, external_wp_i18n_namespaceObject.__ )( 'Try reloading the page.' )
					: null
			)
		);
	};
	/* harmony default export */ var downloadable_block_notice = DownloadableBlockNotice; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-list-item/index.js
		...
		return ( 0, external_wp_element_namespaceObject.createElement )(
			...
			( 0, external_wp_element_namespaceObject.createElement )(
				...
				isInstalling
					...
					: ( 0, external_wp_element_namespaceObject.createElement )( block_ratings, {
							rating: rating,
					  } )
			),
			( 0, external_wp_element_namespaceObject.createElement )(
				...
				hasNotice
					? ( 0, external_wp_element_namespaceObject.createElement )( downloadable_block_notice, {
							block: item,
					  } )
					: ( 0, external_wp_element_namespaceObject.createElement )(
							...
							( 0, external_wp_element_namespaceObject.createElement )(
								...
								!! statusText
									? statusText
									: ( 0, external_wp_htmlEntities_namespaceObject.decodeEntities )( description )
							),
							isInstallable &&
	...
	/* harmony default export */ var downloadable_block_list_item = DownloadableBlockListItem; // CONCATENATED MODULE: ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-list/index.js
	...
	/* harmony default export */ var downloadable_blocks_list = DownloadableBlocksList; // CONCATENATED MODULE: external ["wp","a11y"]
	...
	function DownloadableBlocksInserterPanel( { children, downloadableItems, hasLocalBlocks } ) {
	...
	/* harmony default export */ var inserter_panel = DownloadableBlocksInserterPanel; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/block-default.js
	...
	function DownloadableBlocksPanel( {
		...
		return !! downloadableItems.length
			...
			: ! hasLocalBlocks &&
					( 0, external_wp_element_namespaceObject.createElement )( no_results, null );
	}
	...
	external_wp_compose_namespaceObject.compose )( [
		( 0, external_wp_data_namespaceObject.withSelect )(
			( select, { filterValue, rootClientId = null } ) => {
				...
				const { canInsertBlockType } = select( external_wp_blockEditor_namespaceObject.store );
	...
	function InserterMenuDownloadableBlocksPanel() {
		...
		const debouncedSetFilterValue = ( 0, external_wp_compose_namespaceObject.debounce )(
			setFilterValue,
			400
		);
		return ( 0, external_wp_element_namespaceObject.createElement )(
	...
	const { PluginPrePublishPanel } =
		( _window$wp$editPost = window?.wp?.editPost ) !== null && _window$wp$editPost !== void 0
			? _window$wp$editPost
			: {};
	...
	( 0, external_wp_plugins_namespaceObject.registerPlugin )( 'block-directory', {
		render() {
			return ( 0, external_wp_element_namespaceObject.createElement )(
				external_wp_element_namespaceObject.Fragment,
				null,
				( 0, external_wp_element_namespaceObject.createElement )( AutoBlockUninstaller, null ),
				( 0, external_wp_element_namespaceObject.createElement )(

/******/ ( function () {
	...
	/******/ var __webpack_modules__ = {
		/***/ 5360: /***/ function (
			...
			/* harmony export */ __webpack_require__.d( __webpack_exports__, {
				/* harmony export */ createUndoManager: function () {
					return /* binding */ createUndoManager;
				},
				/* harmony export */
			} );
			...
			const addHistoryChangesIntoRecord = ( record, changes ) => {
				const existingChangesIndex = record?.findIndex( ( { id: recordIdentifier } ) => {
					...
					const filteredRecord = record.filter( ( { changes } ) => {
						return Object.values( changes ).some(
							( { from, to } ) =>
								...
								typeof to !== 'function' &&
								! _wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_0___default()( from, to )
						);
					} );
	...
	! ( function () {
		...
		__webpack_require__.d( build_module_actions_namespaceObject, {
			...
			receiveNavigationFallbackId: function () {
				return receiveNavigationFallbackId;
			},
			receiveThemeGlobalStyleRevisions: function () {
				return receiveThemeGlobalStyleRevisions;
			},
		...
		__webpack_require__.d( build_module_selectors_namespaceObject, {
			...
			getCurrentThemeGlobalStylesRevisions: function () {
				return getCurrentThemeGlobalStylesRevisions;
			},
			...
			getUserPatternCategories: function () {
				return getUserPatternCategories;
			},
		...
		__webpack_require__.d( private_selectors_namespaceObject, {
			getNavigationFallbackId: function () {
		...
		__webpack_require__.d( resolvers_namespaceObject, {
			...
			getCurrentThemeGlobalStylesRevisions: function () {
				return resolvers_getCurrentThemeGlobalStylesRevisions;
			},
			getCurrentUser: function () {
			...
			getNavigationFallbackId: function () {
				return resolvers_getNavigationFallbackId;
			},
			getRawEntityRecord: function () {
			...
			getUserPatternCategories: function () {
				return resolvers_getUserPatternCategories;
			},
		...
		var build_module = __webpack_require__( 5360 ); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/if-matching-action.js
		...
		/* harmony default export */ var on_sub_key = onSubKey; // CONCATENATED MODULE: ./node_modules/tslib/tslib.es6.mjs
...
***************************************************************************** */
		...
		var external_wp_i18n_namespaceObject = window[ 'wp' ][ 'i18n' ]; // CONCATENATED MODULE: ./node_modules/uuid/dist/esm-browser/native.js
		const randomUUID =
		...
		/* harmony default export */ var esm_browser_stringify =
				...
				async run() {
					...
					results.forEach( ( result, key ) => {
						...
						if ( result?.error ) {
							...
							var _result$output;
							queueItem?.resolve(
								( _result$output = result?.output ) !== null && _result$output !== void 0
									? _result$output
									: result
							);
						}
		...
		const deleteEntityRecord =
			(
				...
				recordId,
				query,
				{ __unstableFetch = external_wp_apiFetch_default(), throwOnError = false } = {}
			) =>
			async ( { dispatch } ) => {
		...
		const rootEntitiesConfig = [
			...
			},
			{
				...
				getTitle: record => {
					var _record$title;
					return ( _record$title = record?.title ) !== null && _record$title !== void 0
						? _record$title
		...
		async function loadPostTypeEntities() {
			...
			return Object.entries( postTypes !== null && postTypes !== void 0 ? postTypes : {} ).map(
				( [ name, postType ] ) => {
					...
					return {
						...
						getTitle: record => {
							...
							return (
								...
								( isTemplate
									? capitalCase(
											( _record$slug = record.slug ) !== null && _record$slug !== void 0
												? _record$slug
												: ''
									  )
									: String( record.id ) )
		...
		async function loadTaxonomyEntities() {
			...
			return Object.entries( taxonomies !== null && taxonomies !== void 0 ? taxonomies : {} ).map(
				( [ name, taxonomy ] ) => {
		...
		/* harmony default export */ var get_normalized_comma_separable = getNormalizedCommaSeparable; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/utils/with-weak-map-cache.js
				...
				switch ( key ) {
					...
					default:
						...
						if ( key === '_fields' ) {
							...
							parts.fields =
								( _getNormalizedCommaSe = get_normalized_comma_separable( value ) ) !== null &&
						...
						if ( key === 'include' ) {
							...
							parts.include = (
								( _getNormalizedCommaSe2 = get_normalized_comma_separable( value ) ) !== null &&
		...
		/* harmony default export */ var get_query_parts = with_weak_map_cache( getQueryParts ); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/reducer.js
		...
		const entities = ( state = {}, action ) => {
			...
			if ( ! entitiesDataReducer || newConfig !== state.config ) {
				...
				entitiesDataReducer = ( 0, external_wp_data_namespaceObject.combineReducers )(
					Object.entries( entitiesByKind ).reduce( ( memo, [ kind, subEntities ] ) => {
						const kindReducer = ( 0, external_wp_data_namespaceObject.combineReducers )(
							subEntities.reduce(
		...
		var equivalent_key_map_default = /*#__PURE__*/ __webpack_require__.n( equivalent_key_map ); // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/queried-data/selectors.js
		/**
		 * External dependencies
		 */
		 ...
		 */
		const isRequestingEmbedPreview = ( 0, external_wp_data_namespaceObject.createRegistrySelector )(
			select => ( state, url ) => {
		...
		const getEntityRecord = rememo(
			( state, kind, name, key, query ) => {
				...
				if ( item && query._fields ) {
					...
					const filteredItem = {};
					const fields =
						( _getNormalizedCommaSe = get_normalized_comma_separable( query._fields ) ) !== null &&
						_getNormalizedCommaSe !== void 0
							? _getNormalizedCommaSe
							: [];
					for ( let f = 0; f < fields.length; f++ ) {
			...
			( state, kind, name, recordId, query ) => {
				var _query$context2;
				const context =
					( _query$context2 = query?.context ) !== null && _query$context2 !== void 0
						? _query$context2
						: 'default';
				return [
					state.entities.records?.[ kind ]?.[ name ]?.queriedData?.items[ context ]?.[ recordId ],
					state.entities.records?.[ kind ]?.[ name ]?.queriedData?.itemIsComplete[ context ]?.[
						recordId
					],
				];
			}
		...
		const getRawEntityRecord = rememo(
				...
				return (
					...
					Object.keys( record ).reduce( ( accumulator, _key ) => {
						if ( isRawAttribute( getEntityConfig( state, kind, name ), _key ) ) {
							...
							accumulator[ _key ] =
								( _record$_key$raw = record[ _key ]?.raw ) !== null && _record$_key$raw !== void 0
									? _record$_key$raw
									: record[ _key ];
						} else {
			...
			( state, kind, name, recordId, query ) => {
				var _query$context3;
				const context =
					( _query$context3 = query?.context ) !== null && _query$context3 !== void 0
						? _query$context3
						: 'default';
				return [
		...
		const __experimentalGetEntitiesBeingSaved = rememo(
			state => {
				...
				Object.keys( records ).forEach( kind => {
					Object.keys( records[ kind ] ).forEach( name => {
						const primaryKeys = Object.keys( records[ kind ][ name ].saving ).filter( primaryKey =>
		...
		const getEditedEntityRecord = rememo(
			...
			( state, kind, name, recordId, query ) => {
				var _query$context4;
				const context =
					( _query$context4 = query?.context ) !== null && _query$context4 !== void 0
						? _query$context4
						: 'default';
				return [
					state.entities.config,
		...
		function isSavingEntityRecord( state, kind, name, recordId ) {
			...
			return ( _state$entities$recor2 =
				state.entities.records?.[ kind ]?.[ name ]?.saving?.[ recordId ]?.pending ) !== null &&
				_state$entities$recor2 !== void 0
		...
		function isDeletingEntityRecord( state, kind, name, recordId ) {
			...
			return ( _state$entities$recor3 =
				state.entities.records?.[ kind ]?.[ name ]?.deleting?.[ recordId ]?.pending ) !== null &&
				_state$entities$recor3 !== void 0
		...
		function getThemeSupports( state ) {
			...
			return ( _getCurrentTheme$them = getCurrentTheme( state )?.theme_supports ) !== null &&
		 ...
		 */
		const hasFetchedAutosaves = ( 0, external_wp_data_namespaceObject.createRegistrySelector )(
		...
		const resolvers_getCurrentThemeGlobalStylesRevisions =
			...
			async ( { resolveSelect, dispatch } ) => {
				...
				const record = globalStylesId
					? await resolveSelect.getEntityRecord( 'root', 'globalStyles', globalStylesId )
					: undefined;
				...
				if ( revisionsURL ) {
					...
					const revisions = resetRevisions?.map( revision =>
						Object.fromEntries(
							Object.entries( revision ).map( ( [ key, value ] ) => [ camelCase( key ), value ] )
						)
					);
		...
		var external_wp_privateApis_namespaceObject = window[ 'wp' ][ 'privateApis' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/private-apis.js
		/**
		 * WordPress dependencies
		 */
		...
		var external_wp_blocks_namespaceObject = window[ 'wp' ][ 'blocks' ]; // CONCATENATED MODULE: external ["wp","blockEditor"]
		var external_wp_blockEditor_namespaceObject = window[ 'wp' ][ 'blockEditor' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/footnotes/get-rich-text-values-cached.js
		/**
		 * WordPress dependencies
		 */
		...
		function useEntityProp( kind, name, prop, _id ) {
			...
			const { value, fullValue } = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => {
		...
		function useEntityBlockEditor( kind, name, { id: _id } = {} ) {
			const providerId = useEntityId( kind, name );
			const id = _id !== null && _id !== void 0 ? _id : providerId;
			const { content, editedBlocks, meta } = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => {
			...
			const blocks = ( 0, external_wp_element_namespaceObject.useMemo )( () => {
				...
				return content && typeof content !== 'function'
					? ( 0, external_wp_blocks_namespaceObject.parse )( content )
					: EMPTY_ARRAY;
			}, [ editedBlocks, content ] );
			const updateFootnotes = ( 0, external_wp_element_namespaceObject.useCallback )(
		...
		/* harmony default export */ var _experimental_fetch_link_suggestions = fetchLinkSuggestions; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/fetch/__experimental-fetch-url-data.js
		...
		/* harmony default export */ var _experimental_fetch_url_data = fetchUrlData; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/fetch/index.js
		...
		/* harmony default export */ var memoize = memize; // CONCATENATED MODULE: ./node_modules/@wordpress/core-data/build-module/hooks/constants.js
		...
		function useEntityRecord(
			...
			const { editedRecord, hasEdits, edits } = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => ( {
		...
		function useResourcePermissions( resource, id ) {
			return useQuerySelect(
				resolve => {
					...
					const isResolving =
						read.isResolving || create.isResolving || update.isResolving || _delete.isResolving;
					const hasResolved =
						read.hasResolved && create.hasResolved && update.hasResolved && _delete.hasResolved;
					let status = Status.Idle;
					if ( isResolving ) {
						status = Status.Resolving;
					} else if ( hasResolved ) {

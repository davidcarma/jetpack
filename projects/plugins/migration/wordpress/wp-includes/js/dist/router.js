/******/ ( function () {
	...
	var external_wp_url_namespaceObject = window[ 'wp' ][ 'url' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/router/build-module/history.js
	/**
	...
	function push( params, state ) {
		...
		const currentUrlWithoutArgs = ( 0, external_wp_url_namespaceObject.removeQueryArgs )(
	...
	/* harmony default export */ var build_module_history = history_history; // CONCATENATED MODULE: ./node_modules/@wordpress/router/build-module/router.js
	...
	function RouterProvider( { children } ) {
		const [ location, setLocation ] = ( 0, external_wp_element_namespaceObject.useState )( () =>
			getLocationWithParams( build_module_history.location )
		);
		( 0, external_wp_element_namespaceObject.useEffect )( () => {
			return build_module_history.listen( ( { location: updatedLocation } ) => {
	...
	var external_wp_privateApis_namespaceObject = window[ 'wp' ][ 'privateApis' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/router/build-module/lock-unlock.js
	/**
	 * WordPress dependencies
	 */

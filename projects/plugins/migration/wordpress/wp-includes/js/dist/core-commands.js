/******/ ( function () {
	...
	var external_wp_commands_namespaceObject = window[ 'wp' ][ 'commands' ]; // CONCATENATED MODULE: external ["wp","i18n"]
	var external_wp_i18n_namespaceObject = window[ 'wp' ][ 'i18n' ]; // CONCATENATED MODULE: external ["wp","element"]
	var external_wp_element_namespaceObject = window[ 'wp' ][ 'element' ]; // CONCATENATED MODULE: external ["wp","primitives"]
	var external_wp_primitives_namespaceObject = window[ 'wp' ][ 'primitives' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/plus.js
	/**
	...
	/* harmony default export */ var library_plus = plus; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/symbol.js
	...
	/* harmony default export */ var library_symbol = symbol; // CONCATENATED MODULE: external ["wp","url"]

	var external_wp_url_namespaceObject = window[ 'wp' ][ 'url' ]; // CONCATENATED MODULE: external ["wp","router"]
	var external_wp_router_namespaceObject = window[ 'wp' ][ 'router' ]; // CONCATENATED MODULE: external ["wp","coreData"]
	var external_wp_coreData_namespaceObject = window[ 'wp' ][ 'coreData' ]; // CONCATENATED MODULE: external ["wp","data"]
	var external_wp_data_namespaceObject = window[ 'wp' ][ 'data' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-commands/build-module/hooks.js
	/**
	 * WordPress dependencies
	 */
	...
	function useIsTemplatesAccessible() {
		return ( 0, external_wp_data_namespaceObject.useSelect )(
			select => select( external_wp_coreData_namespaceObject.store ).canUser( 'read', 'templates' ),
			[]
		);
	}
	function useIsBlockBasedTheme() {
		return ( 0, external_wp_data_namespaceObject.useSelect )(
			select =>
				select( external_wp_coreData_namespaceObject.store ).getCurrentTheme()?.is_block_theme,
			[]
		);
	} // CONCATENATED MODULE: external ["wp","privateApis"]

	var external_wp_privateApis_namespaceObject = window[ 'wp' ][ 'privateApis' ]; // CONCATENATED MODULE: ./node_modules/@wordpress/core-commands/build-module/lock-unlock.js
	/**
	 * WordPress dependencies
	 */
	...
	/* harmony default export */ var library_page = page; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/layout.js
	...
	/* harmony default export */ var symbol_filled = symbolFilled; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/navigation.js
	...
	/* harmony default export */ var library_navigation = navigation; // CONCATENATED MODULE: ./node_modules/@wordpress/icons/build-module/library/styles.js
	...
	/* harmony default export */ var library_styles = styles; // CONCATENATED MODULE: ./node_modules/@wordpress/core-commands/build-module/utils/order-entity-records-by-search.js
	...
	const { useHistory: site_editor_navigation_commands_useHistory, useLocation } = unlock(
			...
			const commands = ( 0, external_wp_element_namespaceObject.useMemo )( () => {
				return ( records !== null && records !== void 0 ? records : [] ).map( record => {
					...
					const extraArgs = isSiteEditor
						? {
								canvas: ( 0, external_wp_url_namespaceObject.getQueryArg )(
									window.location.href,
									'canvas'
								),
						  }
	...
	const getNavigationCommandLoaderPerTemplate = templateType =>
		function useNavigationCommandLoader( { search } ) {
			...
			const isPatternsPage =
				location?.params?.path === '/patterns' || location?.params?.postType === 'wp_block';
						...
						callback: ( { close } ) => {
							const args = {
								...
								didAccessPatternsPage:
									! isBlockBasedTheme && ( isPatternsPage || didAccessPatternsPage )
										? 1
										: undefined,
								...extraArgs,
							};

/******/ ( function () {
	...
	/* harmony default export */ var media_upload = MediaUpload; // CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/components/index.js
		...
		for ( let idx = 0; idx < validFiles.length; ++idx ) {
			...
			try {
				...
				const mediaObject = {
					...
					caption:
						( _savedMedia$caption$r = savedMedia.caption?.raw ) !== null &&

	...
	! ( function () {
		...
		function InspectorCard( { name, description } ) {
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				( 0, external_wp_element_namespaceObject.createElement )( 'span', null, description )
			);
		...
		class Control {
			 ...
			 */
			constructor( { id, idBase, instance, onChangeInstance, onChangeHasPreview, onError } ) {
				this.id = id;
				this.idBase = idBase;
		...
		function Form( {
			...
			const isMediumLargeViewport = ( 0, external_wp_compose_namespaceObject.useViewportMatch )(
				'small'
			);
		...
		function Preview( { idBase, instance, isVisible } ) {
			const [ isLoaded, setIsLoaded ] = ( 0, external_wp_element_namespaceObject.useState )(
				false
			);
				...
				iframe => {
					...
					function setHeight() {
						...
						const height = Math.max(
							( _iframe$contentDocume = iframe.contentDocument.documentElement?.offsetHeight ) !==
								null && _iframe$contentDocume !== void 0
								? _iframe$contentDocume
								: 0,
							( _iframe$contentDocume2 = iframe.contentDocument.body?.offsetHeight ) !== null &&
		...
		function NoPreview( { name } ) {
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				name && ( 0, external_wp_element_namespaceObject.createElement )( 'h3', null, name ),
				( 0, external_wp_element_namespaceObject.createElement )(
					'p',
					null,
		...
		function Edit( props ) {
			...
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				! id && ! idBase
					? ( 0, external_wp_element_namespaceObject.createElement )( Empty, {
							...props,
					  } )
		...
		function NotEmpty( {
			...
			const [ hasPreview, setHasPreview ] = ( 0, external_wp_element_namespaceObject.useState )(
				null
			);
			const widgetTypeId = id !== null && id !== void 0 ? id : idBase;
			const { record: widgetType, hasResolved: hasResolvedWidgetType } = ( 0,
			external_wp_coreData_namespaceObject.useEntityRecord )( 'root', 'widgetType', widgetTypeId );
			const isNavigationMode = ( 0, external_wp_data_namespaceObject.useSelect )(
				select => select( external_wp_blockEditor_namespaceObject.store ).isNavigationMode(),
				[]
			);
			...
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				( 0, external_wp_element_namespaceObject.createElement )(
					...
					null,
					( 0, external_wp_element_namespaceObject.createElement )( InspectorCard, {
				...
				idBase &&
					( 0, external_wp_element_namespaceObject.createElement )(
						...
						hasPreview === false &&
							mode === 'preview' &&
							( 0, external_wp_element_namespaceObject.createElement )( NoPreview, {
								name: widgetType.name,
							} )
					)
			);
		...
		function edit_Edit( props ) {
			...
			return ( 0, external_wp_element_namespaceObject.createElement )(
				...
				innerBlocks.length === 0
					? ( 0, external_wp_element_namespaceObject.createElement )( PlaceholderContent, {
							...props,
					  } )
		...
		function registerLegacyWidgetVariations( settings ) {
			const unsubscribe = ( 0, external_wp_data_namespaceObject.subscribe )( () => {
				...
				const hiddenIds =
					( _settings$widgetTypes = settings?.widgetTypesToHideFromLegacyWidgetBlock ) !== null &&

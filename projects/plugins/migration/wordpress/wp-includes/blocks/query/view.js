...
( self[ '__WordPressPrivateInteractivityAPI__' ] =
	self[ '__WordPressPrivateInteractivityAPI__' ] || [] ).push( [
	[ 155 ],
	{
		/***/ 890: /***/ function (
			...
			( 0, _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__ /* .store */.h )( {
				selectors: {
					core: {
						query: {
							startAnimation: ( { context } ) => context.core.query.animation === 'start',
							finishAnimation: ( { context } ) => context.core.query.animation === 'finish',
						},
					},
				},
				actions: {
					core: {
						query: {
							navigate: async ( { event, ref, context } ) => {
								const isDisabled =
									ref.closest( '[data-wp-navigation-id]' )?.dataset.wpNavigationDisabled;
								if ( isValidLink( ref ) && isValidEvent( event ) && ! isDisabled ) {
									...
									await ( 0,
									_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__ /* .navigate */.c4 )(
										ref.href
									);
									...
									context.core.query.message =
										...
										( context.core.query.message === context.core.query.loadedText
											? '\u00A0'
											: '' );
							...
							prefetch: async ( { ref } ) => {
								...
								if ( isValidLink( ref ) && ! isDisabled ) {
									await ( 0,
									_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__ /* .prefetch */.tL )(
										ref.href
									);
								}
							},
